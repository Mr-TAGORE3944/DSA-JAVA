public class DistinctSubsequences {
    public int numDistinct(String s, String t) {
        ...
        // dp[i][j] will store the number of distinct subsequences of s[0..i-1] matching t[0..j-1]
        int[][] dp = new int[n + 1][m + 1];

        // Initialization: An empty string t is a subsequence of any string s (there is exactly 1 subsequence of "")
        for (int i = 0; i <= n; i++) {
            dp[i][0] = 1;
        }
        ...
        // The result is stored in dp[n][m] which gives the number of distinct subsequences of s that equal t
        return dp[n][m];
    }
